...
namespace STS2MultiPlayerPotionView.Utils
{
    internal static class PotionDisplaySettings
    {
        ...
        {
            var scale = Mathf.Clamp(GetSettings().ContentScale, 0.5f, 2.0f);
            return Vector2.One * (DefaultSlotSize * scale);
        }
        ...
        public static bool ShouldHighlight(PotionModel potion)
        {
            ...
            var candidates = potion.HoverTips
                .SelectMany(GetTexts)
        ...
        private static Data.Models.ModSettings GetSettings()
        {
            return ModDataStore.Get<Data.Models.ModSettings>(ModDataStore.SettingsKey);
        }
